	...
	return (
		<>
			...
			>
				...
				{/*Directional Light Shining from the back*/}
				<spotLight
					position={[0, 50, 0]}
				...
				>
					<planeGeometry args={[100, 100]} />
					<meshBasicMaterial color="black" roughness={0.8} />
				</mesh>
